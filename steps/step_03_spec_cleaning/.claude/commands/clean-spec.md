---
description: Run one cleaning pass — find one reduction candidate in the working STEP3_CLEAN_SPEC.md (duplicated concepts, overlapping abstractions, needless options, unclear terms, historical artifacts), propose it with a behavior-preservation justification, and apply it only on the user's explicit approval, logging it to STEP3_SPEC_OPTIMISATION.md.
