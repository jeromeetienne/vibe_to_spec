...
4. Otherwise: agree with the user the gap list to hand back to phase 4; record it under `## Handed back on <date>` in VERIFICATION.md; set `Status: concluded on <date> — gaps handed back`. Phase 4 reopens, and verification runs again after the fixes.
