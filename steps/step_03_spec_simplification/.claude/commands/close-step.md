...
1. Full sweep: go through every SPEC.md section once more hunting for reduction candidates. If any are found, present them — the phase is not ready to close; go back to /simplify-spec.
...
4. Only if the user explicitly answers yes:
   ...
   - tell the user phase 3 is complete, this SPEC.md is now the source of truth, and phase 4 can start in ../step_04_implementation.
