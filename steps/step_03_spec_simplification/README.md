...
- **Precondition**: step 2 is done — `../step_02_spec_extraction/STEP2_VIBE_SPEC.md` fully describes the prototype, and the user agreed it does.
...
- **Hand-off**: this folder's `STEP3_PRODUCTION_SPEC.md` becomes **the source of truth**. Steps 4 and 5 read it. From this point on, the step 1 prototype no longer matters — implementations are built and judged from this specification alone.
